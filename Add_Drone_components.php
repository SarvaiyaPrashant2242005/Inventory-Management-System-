...
if (isset($_REQUEST['btnDelete'])) {
    ...
    $sql = "DELETE FROM Drone WHERE id = $delete_id";
...
if (isset($_POST['btnSave'])) {
    ...
    foreach ($_POST['quantities'] as $componentId => $quantity) {
        ...
        $sql = "UPDATE Drone SET quantities = '$quantity' WHERE id = $componentId";
        if (!mysqli_query($link, $sql)) {
        ...
        <div class="col-md-12">
            ...
            if (isset($_REQUEST['btnAdd'])) {
                ...
                if ($sel_id == -1) {
                    ...
                    $sql  = "UPDATE Drone SET componet = '$componet', quantities = '$quantities' WHERE id = $sel_id";
                }
