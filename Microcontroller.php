                ...
                <div class="col-md-12">
                    ...
                    ?>
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-primary request-btn" data-component="<?php echo urlencode($row['componet']); ?>" data-quantity="<?php echo $row['quantities']; ?>">Request</button>
                                    </td>
                                </tr>
                    <?php
                            }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        requestButtons.forEach(function(button) {
            button.addEventListener('click', function() {
                ...
                var availableQuantity = parseInt(button.getAttribute('data-quantity'));
                ...
                if (quantity !== null && quantity.trim() !== '') {
                    ...
                    if (!isNaN(quantity) && quantity > 0 && quantity <= availableQuantity) {
                        ...
                        alert('Sorry! Sufficient quantity not available as your requirment');
                    }
                } else {
