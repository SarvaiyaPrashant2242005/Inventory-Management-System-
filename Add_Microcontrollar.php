...
if (isset($_REQUEST['btnEdit'])) {
    $sql = "SELECT * FROM my_project WHERE id = " . $_REQUEST['btnEdit'];
...
if (isset($_REQUEST['btnDelete'])) {
    ...
    $sql = "DELETE FROM my_project WHERE id = $delete_id";
...
if (isset($_POST['btnSave'])) {
    ...
    foreach ($_POST['quantities'] as $componentId => $quantity) {
        ...
        $sql = "UPDATE my_project SET quantities = '$quantity' WHERE id = $componentId";
        if (!mysqli_query($link, $sql)) {
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            if (isset($_REQUEST['btnAdd'])) {
                ...
                if ($sel_id == -1) {
                    $sql = "INSERT INTO my_project (componet, quantities) VALUES ('$componet', '$quantities')";
                } else {
                    $sql  = "UPDATE my_project SET componet = '$componet', quantities = '$quantities' WHERE id = $sel_id";
                }
